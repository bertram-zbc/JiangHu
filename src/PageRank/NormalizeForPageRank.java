...
public class NormalizeForPageRank {
    ...
    public static void run(String input,String output) throws Exception{
        ...
        Job job1 = new Job(conf, "Normalize For PageRank");
        job1.setJarByClass(NormalizeForPageRank.class);
    ...
    public static void main(String[]args) throws Exception{
        if(args.length!=2) {
            System.out.println("input path:count,output path:forPR");
            run("count", "forPR");
        }else{
            run(args[0],args[1]);
        }
